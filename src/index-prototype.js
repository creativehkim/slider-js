...
Slider.prototype.move = function(direction) {
  ...
  if (direction === 'back') {
    ...
    [this.prev, this.current, this.next] = [
      // get the prev slide, if there is none, geet the last slide from the entire slider for wrapping
      this.prev.previousElementSibling || this.slides.lastElementChild, this.prev, this.current];
  } else {
    [this.prev, this.current, this.next] = [this.current, this.next, 
      // get the next slide, if it's at the end, loop around and grab the first slide
